...
#        cluster = dispy.JobCluster(compute, ip_addr='127.0.0.1')
#        # For running on LISA:
...
#    return fitness_values_gp
    ...
    def run_gp(self, states, population_size_gp, generations, max_model_depth,
        ...
        self.training_data = training_data_p
        self.test_data = test_data_p
        self.eval_aspects = eval_aspects_p
        self.output_directory = self.util.create_output_directory()
        self.parallel = parallel_p
        print '-----'
        print mp.cpu_count()
